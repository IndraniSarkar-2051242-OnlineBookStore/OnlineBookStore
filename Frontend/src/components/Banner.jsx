  ...
  return (
    ...
    <div className=" max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-20 ">
        <div className="w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-32">
            ...
            <p className="text-xl">
            At bookStore, we believe in the magic of books to ignite imaginations and transform lives. Our curated selection ranges from the latest bestsellers to timeless classics, ensuring there's something for every reader.
            </p>
